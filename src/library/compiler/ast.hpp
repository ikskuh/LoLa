...
namespace LoLa::AST
{
    ...
    struct StatementBase
    {
        ...
        virtual void emit(Compiler::CodeWriter &writer, Compiler::Scope &scope, Compiler::ErrorCollection &errors) = 0;
    };
    ...
    {
        virtual void emitStore(Compiler::CodeWriter &writer, Compiler::Scope &scope, Compiler::ErrorCollection &errors) = 0;
    };
